...
public: /* PlayerScript */
	...
	void OnPlayerLearnedSkillsChange(Player* player, uint32 skillId);
...
public: /* UnitScript */
    ...
    void AfterHeal(Unit* healer, Unit* reciever, uint32& gain);
    void OnDamage(Unit* attacker, Unit* victim, uint32& damage);
    void AbsorbScaling(Unit* attacker, Unit* victim, float& AbsorbScaling);
    void AfterDamage(Unit* attacker, Unit* victim, uint32& damage);
