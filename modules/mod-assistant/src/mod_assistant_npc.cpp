...
bool Assistant::OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
{
    ...
    else if (action == ASSISTANT_GOSSIP_ELIXIRS)
    {
        ...
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_ELIXIRS_FLASK, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_ELIXIRS + 3);
        AddGossipItemFor(player, GOSSIP_ICON_CHAT, GOSSIP_PREVIOUS_PAGE, GOSSIP_SENDER_MAIN, 1);
        SendGossipMenuFor(player, ASSISTANT_GOSSIP_TEXT, creature->GetGUID());
    }
    ...
    else if (action == ASSISTANT_GOSSIP_ENCHANTS)
    {
        ...
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_ENCHANTS_WAIST, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_ENCHANTS + 7);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_ENCHANTS_LEGS, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_ENCHANTS + 8);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_ENCHANTS_FEET, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_ENCHANTS + 9);
        AddGossipItemFor(player, GOSSIP_ICON_VENDOR, GOSSIP_ENCHANTS_CLOAK, GOSSIP_SENDER_MAIN, ASSISTANT_GOSSIP_ENCHANTS + 10);
