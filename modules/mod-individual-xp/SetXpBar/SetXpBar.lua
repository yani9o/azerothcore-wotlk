...
local xpRates = {
    { text = "Erfahrung:", isTitle = true },
    { text = "x1 (Blizzlike)", func = function() SetXpRate(1) end },
    { text = "x1.5", func = function() SetXpRate(1.5) end },
    { text = "x2", func = function() SetXpRate(2) end },
    { text = "x3", func = function() SetXpRate(3) end },
    { text = "x5", func = function() SetXpRate(5) end },
    { text = "Benutzerdefiniert", func = function() StaticPopup_Show("SET_XP_RATE") end }, -- Open custom XP rate dialog
}
...
StaticPopupDialogs["SET_XP_RATE"] = {
    text = "Benutzerdefinierte XP-Rate eingeben:",
    button1 = "OK",
    button2 = "Abbrechen",
